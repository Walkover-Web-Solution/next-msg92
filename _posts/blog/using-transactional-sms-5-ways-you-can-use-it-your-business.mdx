...
![](https://images-msg91.s3.ap-south-1.amazonaws.com/2021/05/Group-18407.png)**Transactional SMS**A [transactional SMS](https://msg91.com/sms/) is an automated message that serves as a communication tool between businesses and their customers. It is a personalized message that is triggered as a response to a certain action of customers. These actions can be payment transactions, online bookings of products/services, account balance notifications, and so many other types of real-time texts. 
