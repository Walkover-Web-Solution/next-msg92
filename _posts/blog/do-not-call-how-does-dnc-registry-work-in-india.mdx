...
According to the NDNC UCC is defined as “any message, through telecommunications service, which is transmitted [for the purpose of informing](https://msg91.com/sms/?utm_source=blog&utm_medium=int&utm_campaign=dnc) about, or soliciting or promoting any commercial transaction in relation to goods, investments or services which a subscriber opts not to receive.”  
