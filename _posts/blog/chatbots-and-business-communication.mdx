...
description: Remember those times when for even a minor issue we had to wait on hold, listen carefully and then respond to various IVR questions and then finally get connected to a human representative and start the process again.
tags:
  - ai
---
...
![chatbot communication](https://images-msg91.s3.ap-south-1.amazonaws.com/content/images/wordpress/2019/05/andy-kelly-402111-unsplash-1024x683.jpg)
...
For example: Allowing you to connect with customers on one of the most popular mobile chat application, Facebook Messenger, [MobileMonkey](https://mobilemonkey.com) makes marketing automation for the [Facebook Messenger](https://www.messenger.com) channel straightforward.
