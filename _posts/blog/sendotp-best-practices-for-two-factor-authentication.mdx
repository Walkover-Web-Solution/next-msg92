...
Sensing this big gap in the market for [high-priority SMS](https://msg91.com/sms) or what we call OTP, we grabbed the opportunity with both hands and voila ‘[SendOTP](https://msg91.com/send-otp/)’ was conceived and yes, we did make it a cakewalk.  
...
* Technical infrastructure: As in the case of any other provider, make sure your OTP high-priority SMS provider has the technical abilities to deal with different types of SMS, and also has the sound infrastructure to execute these [types of SMS](https://msg91.com/in/sms/) in bulk.
