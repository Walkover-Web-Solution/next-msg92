...
![Jeff Bezos apology test](https://images-msg91.s3.ap-south-1.amazonaws.com/content/images/wordpress/2018/10/1118-aplogies-2-100554191-gallery.idge_-300x214.jpg)
...
As we are talking communication here so let’s take an example of a communication medium, SMS. It has been in use since 1993, more than 25 years now and with time it has become [the most powerful communication medium](https://msg91.com/sms).
...
[Establish smart metrics > Use analysis in an active way > Automate](https://msg91.com/sms)
