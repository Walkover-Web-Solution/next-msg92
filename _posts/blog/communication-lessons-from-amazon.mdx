...
As we are talking communication here so let’s take an example of a communication medium, SMS. It has been in use since 1993, more than 25 years now and with time it has become [the most powerful communication medium](https://msg91.com/sms/?utm_source=blog&utm_medium=int&utm_campaign=amazon).
