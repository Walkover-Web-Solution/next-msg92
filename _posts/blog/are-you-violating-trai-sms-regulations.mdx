...
### **So, [what is a SENDER ID](https://msg91.com/guide/set-your-business-brand-as-your-sender-id-in-bulk-sms)?**
...
All SMS content sent from the transactional route needs to be [transactional](https://msg91.com/sms) and should not contain any promotional content. Doing so is an unethical practice, violates the TRAI regulations and can result in a heavy penalty.
...
[Click here to know more about how NDNC works in India](https://msg91.com/guide/do-not-call-how-does-dnc-registry-work-in-india)
