...
All SMS content sent from the transactional route needs to be [transactional](https://msg91.com/sms/?utm_source=blog&utm_medium=organic&utm_campaign=trai) and should not contain any promotional content. Doing so is an unethical practice, violates the TRAI regulations and can result in a heavy penalty.
