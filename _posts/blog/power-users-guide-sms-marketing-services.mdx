---
title: b'"The Power User\'s Guide To SMS Marketing"'
...
This is personalization and this is what you need to do. Regional SMS allows you to send text in 18 local languages expanding your audience while hitting them right where it matters. For starters, [take your cue from SMS campaign examples](https://msg91.com/blog/send-sms-to-your-customers-in-their-local-language/?utm_source=blog&utm_medium=int&utm_campaign=poweruser).
...
You can schedule your SMS to be sent later automatically at a future time and date. [All you need to do is: Designate recipients – Type your message – Select the date and time – Schedule](https://help.msg91.com/article/164-how-can-i-schedule-an-sms-where-can-i-see-its-delivery-report?utm_source=blog&utm_medium=int&utm_campaign=poweruser)You can also designate a repeat frequency and even ensure you are asked timely before the text is supposed to go out.
...
An OTP or one time password or a means for 2FA, are critical and time-sensitive messages that experienced marketers who follow and sometimes even make the SMS marketing guidelines know [should be sent only via a dedicated OTP platform](https://msg91.com/send-otp/?utm_source=blog&utm_medium=int&utm_campaign=poweruser) and not from the transactional SMS route. 
...
Integrating SMS automation in a workflow not only saves resources or makes the communication flow independent, it also [allows you to create targeted campaigns and automatically gear relevant content](https://msg91.com/blog/marketing-automation-at-scale-strategies-from-the-boardroom/?utm_source=blog&utm_medium=int&utm_campaign=poweruser) and messages based on previous customer communications.
