...
description: I know what MSG91 did last summer! Discover exciting campaigns, automation tips, and messaging strategies to boost your business today.
tags: ""
---
...
1. **SendOTP**: For clients or any enterprise interested ONLY in sending One-Time-Passwords (OTPs), we created a dedicated infrastructure called [SendOTP](https://msg91.com/otp) . We released this service with a policy of SURE-SHOT delivery of OTPs. In case the message is undelivered for any reason and the user requests a voice call, we bear the cost.
...
1. **[Send SMS via Google spreadsheet:](https://msg91.com/sms)** People use Google sheet to store data. Now they can send SMSs directly from there. We got 1,422 downloads within two months of launch.
