...
description: OTP or one-time password refers to the random and uniquely generated code or OTP verification number** which is generated while performing a confidential transaction and sent to the mobile phone as SMS or email address of that person for OTP verification and authentication.
tags:
  - send-otp
---
...
![authentication process](https://images-msg91.s3.ap-south-1.amazonaws.com/2020/12/2FA-_graphics_blog.png)2 Factor AuthenticationAll these sound frightening, right? Now imagine if all these could be prevented by simple know-how. This is where two-factor authentication comes in.
