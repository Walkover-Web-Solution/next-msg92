...
description: We’re living in a mobile-first world. Be it interacting with one another, brands with their customers or the world around us, mobile devices have become our go-to gadget and texting our go-to communication medium.
tags:
...
[Long code or Virtual Number](https://msg91.com/guide/long-code-service-everything-you-wanted-to-know) is a 10 digit mobile number to which your clients or members can send an SMS starting with a keyword. They are designed for conversations.
