---
title: b'"Don\xe2\x80\x99t Ruin Your Marketing Strategy By Missing Out On Language-Based Personalization"'
...
![](http://localhost:8888/wp-content/uploads/2018/07/Send-SMS-in-Regional-languages-using-Regional-SMS-API-MSG91-COM-300x171.png)![SMS in Regional Languages](https://images-msg91.s3.ap-south-1.amazonaws.com/content/images/wordpress/2018/07/Send-SMS-in-Regional-languages-using-Regional-SMS-API-MSG91-COM-3-300x171.png)
...
With [Unicode services](https://msg91.com/blog/unicode-a-way-to-widen-the-reach-of-sms-communication/), MSG91 was already offering the option to reach out to local customers in their local language but now going a step further MSG91 has combined the services of translating SMS with in-company.
...
Not every brand will have a use for regional SMS, especially if they’re targeting a homogenous user base. But brands that are looking to establish themselves glocally—or have already done so—can provide their customers with a clearer, more useful messaging experience by taking advantage of the simple yet powerful [regional SMS functionality](https://msg91.com/regional-sms/).
