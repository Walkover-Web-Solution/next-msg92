...
description: In this mobile-first age where TV ads are skipped and email inboxes automatically filter out promotions, it’s not surprising that marketers are desperate for a tool that can reliably get user’s attention.
tags:
...
2. [USA Today sends targeted ads via text messages](https://www.thefreelibrary.com) that readers can request on their cell phones, in addition to updated information on sports, stocks, weather and other news.
