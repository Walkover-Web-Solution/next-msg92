    ...
    return (
        <>
            ...
            <div className="d-flex justify-content-center">
                <img src="/img/about_Us/walkoverteam.jpg" className="img-fluid" height={729} width={1428} ></img>
            </div>
            ...
            <div class="container row align-items-flex-start mx-auto g-5 pb-5">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="w-100 d-flex flex-column align-items-center"><span class="c-fs-1 rounded-circle social-circle justify-content-center align-items-center d-flex"><img src="/img/about_Us/user_thinking.svg" width="100px" height="35px"></img></span><p class="c-fs-2 c-fw-b px-3 py-3 mt-n2 rounded w-75 text-center ">Thinking like a Customer</p></div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="w-100 d-flex flex-column align-items-center"><span class="c-fs-1 rounded-circle social-circle justify-content-center align-items-center d-flex"><img src="/img/about_Us/star_our.svg" width="100px" height="35px"></img></span><p class="c-fs-2 c-fw-b px-3 py-3 mt-n2 rounded w-75 text-center ">Our Magic Wand is Innovations</p></div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="w-100 d-flex flex-column align-items-center"><span class="c-fs-1 rounded-circle social-circle justify-content-center align-items-center d-flex"><img src="/img/about_Us/trendingup_uplifting.svg" width="100px" height="35px"></img></span><p class="c-fs-2 c-fw-b px-3 py-3 mt-n2 rounded w-75 text-center ">Uplifting each other</p></div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="w-100 d-flex flex-column align-items-center"><span class="c-fs-1 rounded-circle social-circle justify-content-center align-items-center d-flex"><img src="/img/about_Us/feather_sustainability.svg" width="100px" height="35px"></img></span><p class="c-fs-2 c-fw-b px-3 py-3 mt-n2 rounded w-75 text-center ">Sustainability is Priority</p></div>
                </div>
            </div>
                ...
                <div className="row col-lg-8 col-md-9 mx-auto g-2">
                    <div class="col col-lg-4 col-sm-4 col-sm-12  px-5">
                        <div class="card shadow-sm">
                            <div><img src="/img/about_Us/pushpendra_agrawal.jpg" className="card-img-top" alt></img></div>
                            <div class="card-body">
                    ...
                    <div class="col col-lg-4 col-sm-4 col-sm-12 px-5">
                        <div class="card shadow-sm">
                            <div><img src="/img/about_Us/shubhendra_agrawal.png" className="card-img-top" alt></img></div>
                            <div class="card-body">
                    ...
                    <div class="col col-lg-4 col-sm-4 col-sm-12 px-5">
                        <div class="card shadow-sm">
                            <div><img src="/img/about_Us/ravi_dangi.png" className="card-img-top" alt></img></div>
                            <div class="card-body">
                    ...
                    <div class="col col-lg-4 col-sm-4 col-sm-12 px-5">
                        <div class="card shadow-sm">
                            <div><img src="/img/about_Us/vipin_sharma.png" className="card-img-top" alt></img></div>
                            <div class="card-body">
                    ...
                    <div class="col col-lg-4 col-sm-4 col-sm-12 px-5">
                        <div class="card shadow-sm">
                            <div><img src="/img/about_Us/alisha_chouhan.png" className="card-img-top" alt></img></div>
                            <div class="card-body">
                    ...
                    <div class="col col-lg-4 col-sm-4 col-sm-12 px-5">
                        <div class="card shadow-sm">
                        <div><img src="/img/about_Us/chinmay_daga.png" className="card-img-top" alt></img></div>
                            <div class="card-body">
            ...
            <div class="container col-md-12 col-md-12 col-sm-12 mx-auto py-4">
            ...
            <div class="container row mx-auto text-center py-3">
                <div class="col-lg-4 col-md-4 col-sm-12 px-1">
                    <div class="h-100 bg-white border-0 rounded-3">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 px-1">
                    <div class="bg-white border-0 rounded-3">
