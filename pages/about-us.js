  ...
  return (
    <>
      <div className='container text-center justify-content-center p-5'>
        ...
        <div className='d-flex justify-content-center align-items-center flex-column flex-sm-row'>
          <span className='c-fs-2 mx-auto pt-3'>
            We empower developers with communication APIs in addition to
          </span>
        </div>
        <div className='d-flex justify-content-center align-items-center flex-column flex-sm-row'>
          <span className='c-fs-2 mx-auto'>
            building tools &amp; supporting ideas that run majorly on
            communication.
          </span>
        </div>
      </div>
      <div className='d-flex justify-content-center'>
        <img
          src='/img/about_Us/walkoverteam.jpg'
          className='img-fluid'
          height='{729}'
          width='{1428}'
        />
          ...
          <div className='d-lg-flex flex-row align-items-center justify-content-center'>
            ...
            <div className='container paddingCss'>
              ...
              <span className='col-lg-6 col-md-6 col-sm-12 c-fs-2'>
                The team of Superheroes makes us stand out. There are no
                supernatural powers, just the will and dedication to serve you
                helps us in delivering eminence.
              </span>
            </div>
          </div>
        </div>
        ...
        <div className='col-lg-4 col-md-4 col-sm-12 px-1'>
          <div className='h-100 bg-white border-0 rounded-3'>
            ...
            <p className='c-fs-3 c-fw-b'>
              A2P communication provider in India, serving clients worldwide.
            </p>
          </div>
        </div>
        <div className='col-lg-4 col-md-4 col-sm-12 px-1'>
          <div className='bg-white border-0 rounded-3'>
            ...
            <p className='c-fs-3 c-fw-b'>
              OTPs, Transactional &amp; Promotional SMS delivered per month
              without fail.
            </p>
          </div>
        </div>
      ...
      <div className='container row mx-auto text-left '>
        <div className='col-lg-4 col-md-4 col-sm-12 px-2'>
          <div className='h-100 p-3 bg-white border-0 rounded-3 '>
            ...
            <p className='c-fs-4 text-muted'>
              MSG91 has been an extremely reliable communication service for us.
              Their OTP infra has been instrumental in reducing customer
              drop-outs. Great support too!
            </p>
          </div>
        </div>
        <div className='col-lg-4 col-md-4 col-sm-12 px-2'>
          <div className='p-3 bg-white border-0 rounded-3'>
            ...
            <p className='c-fs-4 text-muted'>
              You guys have been instrumental in getting our customer connect
              via SMS trustworthy. Appreciate your technical support services as
        ...
        <div className='col-lg-4 col-md-4 col-sm-12 px-2'>
          <div className='p-3 bg-white border-0 rounded-3'>
            ...
            <p className='c-fs-4 text-muted'>
              MSG91 has helped us in delivering great customer experience
