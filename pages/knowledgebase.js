...
const ParentComponent = ({webhookData, pricingPath , pathArray}) => {  
  const data = json.global.knowledgebase;   
  return (
    <>    
      <ProductComponent pageData={data} webhookData={webhookData} pricingPath={pricingPath} pathArray={pathArray} />    
    </>
  );
};
