    ...
    <>
      <div className="int-page-head firebase d-flex py-3">
        <div className="container d-flex align-items-center gap-4">
          <img src="/img/integrations/firebase-logo.svg" alt="firebase logo"/>
          <div>
      ...
      <div className="container d-flex flex-column flex-sm-row align-items-center  gap-5 my-5">
        ...
        <img className="col-12 col-sm-6" src="/img/integrations/zapeir-graphics.svg" alt="zapeir graphics"/>
      </div>
