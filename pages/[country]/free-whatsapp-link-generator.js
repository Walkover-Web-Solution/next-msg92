    ...
    return (
        <>
                ...
                <div className="container text-center overflow-hidden">
                    <div className=" mx-auto text-center justify-content-center py-2 py-md-5 col-12 col-sm-8">
                        <div className="d-flex justify-content-center align-items-center flex-column flex-sm-row">
                            <img src="/img/icon/whatsapp.svg" className="product-page-logo me-2" alt="whatsapp logo" />
                            <h1 className="heading hello-heading">Free WhatsApp link generator</h1>
                        </div>
                        ...
                        <div className="p-3">
                            <p className="small-heading w-md-75 w-100 mx-auto fw-normal">
                                Simple tool to create WhatsApp click to chat QR code/Widget/Link for your website or
                                landing pages.
                            </p>
                        </div>
                        <a href="#generate" className="btn btn-dark btn-lg c-fs-2 mt-3">
                            Generate
                        </a>
                    </div>
                    <img src="/img/pageimg/wame.png" className="img-fluid product-page-img mx-auto" alt="#" />
                </div>
            </div>

            <div className="container px-4 py-5" id="featured-3">
                <h2 className="sub-heading c-head pt-4 pt-md-0">3 steps to creating a QR code/Widget/Link</h2>
                <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
                    <div className="feature col">
                        ...
                        <p className="c-fs-3  mt-3">
                            Enter your country code and your WhatsApp Business number, and add a welcome message if
                            desired.
                        </p>
                    </div>
                    <div className="feature col">
                        ...
                        <p className="c-fs-3  mt-3">
                            Personalize your widget, QR code, or link to align with your brand's visual guidelines and
                            identity.
                        </p>
                    </div>
                    <div className="feature col">
                        ...
                        <p className="c-fs-3  mt-3">
                            Lastly, simply click the 'Generate Now' button to create your widget, QR code, or link. It's
                            that simple!
                        </p>
                    </div>
                </div>
            ...
            <div className="container px-4 py-5" id="generate">
                <h3 className="sub-heading c-head pt-4 pt-md-0">Create whatsapp Link / Widget/ QR Code</h3>
                <div className="row g-4 py-5 row-cols-1 row-cols-lg-2">
                        ...
                        <form className="needs-validation me-5" noValidate="">
                            ...
                            <div className="row g-3">
                                <div className="col-12">
                                    <p className="mb-3">
                                        Enter your WhatsApp number along with your country code (without the ‘+’
                                        symbol). For instance, if your country code is +91 and your WhatsApp number is
                                        872849182, just type 91872849182.
                                    </p>
                                ...
                                <div className="col-12">
                                    <p className="mb-3">
                                        Automatically send this text when a user clicks on your chat link, making it
                                        easier to start a conversation.
                                    </p>
                                    <label htmlFor="wqinputtext" className="form-label">
                                        Pre-Filled Message <span className="text-secondary">(Optional)</span>
                                    </label>
                                    <textarea
                                        className="form-control"
                                        id="wqinputtext"
                            ...
                            <div className="row g-3">
                                <div className="col-12">
                                    <label htmlFor="whatsappChatWidgetWelcomeText" className="form-label">
                                        Welcome text
                                    </label>
                                ...
                                <div className="col-12">
                                    <label htmlFor="whatsappChatWidgetBrandImage" className="form-label">
                                        Brand image URL
                            ...
                            <button className="wq-create-link-btn btn btn-success btn-lg mt-5" type="submit">
                                Generate Now
                            </button>
                        </form>
                    </div>
                    ...
                    <div className="col-md-6" id="widget-preview" style={{ display: 'none' }}>
                        <h4 className="d-flex align-items-center">
                            <span className="">Widget preview</span>
                            <button id="edit" type="button" className="btn btn-link">
                                Edit
                            </button>
                        </h4>
                        <div id="wq-generated-output" className="d-flex align-items-center mb-3">
                            <div className="wq-link-display-box me-2">
                                https://wa.me/WhatsApp number?text=Pre-Filled Message
                            </div>
                        </div>
                        <div className="preview-bg">
                            ...
                            <div className="col s8 adjustbxflex mb-5" style={{ justifyContent: 'center' }}>
                                <div
                    ...
                    <div className="col-md-6" id="widget-code-wrp" style={{ display: 'none' }}>
                        ...
                        <pre style={{ position: 'relative' }}>
                            ...
                            <code id="widget-code" className="language-javascript"></code>
                        </pre>
                    </div>
                </div>
                <div>
                    ...
                    <div className="accordion accordion-flush" id="accordionFlushExample">
                        <div className="accordion-item">
                            ...
                            >
                                <div className="accordion-body">
                                    WhatsApp links use a specific URL format that, when clicked, opens the WhatsApp app
                                    on a user's device and starts a chat with the provided phone number or message.
                                </div>
                            </div>
                        </div>
                        <div className="accordion-item">
                            ...
                            >
                                <div className="accordion-body">
                                    Yes, absolutely. When utilizing the <a href={`${path}/whatsapp`}>WhatsApp API</a>,
                                    you can include a pre-filled message along with the phone number in the link.
                                    Services like MSG91 offer WhatsApp link generators that allow you to easily create
                                    these links.
                                </div>
                            </div>
                        </div>
                        <div className="accordion-item">
                            ...
                            >
                                <div className="accordion-body">
                                    Yes, WhatsApp link generators can create links for both personal and business
                                    accounts. Business accounts often have additional features suitable for customer
                                    interactions.
                                </div>
                            </div>
                        </div>
                        <div className="accordion-item">
                            ...
                            >
                                <div className="accordion-body">
                                    Yes, WhatsApp links work across different platforms, including iOS, Android, and web
                                    browsers, ensuring a seamless experience for users regardless of their device.
                                </div>
                            </div>
                        </div>
                        <div className="accordion-item">
                            ...
                            >
                                <div className="accordion-body">
                                    You can generate a WhatsApp link by appending the phone number to the WhatsApp URL:
                                    https://wa.me/phonenumbers. For example, to create a link for the number 1234567890,
                                    the URL would be https://wa.me/1234567890.
                                </div>
                            </div>
                        </div>
                    </div>
