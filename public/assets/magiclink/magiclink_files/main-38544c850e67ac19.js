                                    ...
                                    if (i.startsWith('/')) {
                                        ...
                                        return Promise.all([
                                            ...
                                            if (
                                                ...
                                                (!o &&
                                                    i.includes(
                                                        f.normalizeLocalePath(w.removeBasePath(s), r.router.locales)
                                                            .pathname
                                                    ))
                                            ) {
                                    ...
                                    if (c.startsWith('/')) {
                                        let e = P.parsePath(c),
                                            t = O.formatNextPathnameInfo(
                                                a(
                                                    {},
                                                    C.getNextPathnameInfo(e.pathname, { nextConfig: n, parseData: !0 }),
                ...
                let {
                    ...
                    p = (e) =>
                        (function e(t, r, n) {
                            ...
                            .then(
                                (e) => (
                                    (u && 'no-cache' !== e.response.headers.get('x-middleware-cache')) || delete n[f], e
                                )
                            )
                            .catch((e) => {
                                throw (
            ...
            class $ {
                ...
                change(e, t, r, o, i) {
                    ...
                    return n(function* () {
                        ...
                        d._inFlightRoute &&
                            ...
                            (r = E.addBasePath(
                                b.addLocale(x.hasBasePath(r) ? w.removeBasePath(r) : r, o.locale, d.defaultLocale)
                            ));
                        ...
                        try {
                            ...
                            if (
                                (p ||
                                    o.shallow ||
                                    (yield d._bfl(r, 'resolvedAs' in l ? l.resolvedAs : void 0, C.locale)),
                                'route' in l && ee)
                            ) {
                                ...
                                if (
                                    ...
                                    let e =
                                            !U.shallow && l.resolvedAs
                                                ? l.resolvedAs
                                                : E.addBasePath(
                                                      b.addLocale(new URL(r, location.href).pathname, C.locale),
                                                      !0
                                                  ),
                                        t = e;
                            ...
                            if (p && er) {
                                ...
                                try {
                                    ...
                                    throw (
                                        (c.default(e) && e.cancelled && $.events.emit('routeChangeError', e, q, U), e)
                                    );
                                }
                                return !0;
                            }
                        ...
                        try {
                            ...
                            if (
                                ...
                                (null == R ? void 0 : null == (b = R.effect) ? void 0 : b.type) ===
                                    'redirect-internal' ||
                                    (null == R ? void 0 : null == (S = R.effect) ? void 0 : S.type) ===
                                        'redirect-external')
                            )
                                return R.effect;
                            if ((null == R ? void 0 : null == (E = R.effect) ? void 0 : E.type) === 'rewrite') {
                                ...
                                if (
                                    ...
                                    (s = w.removeBasePath(
                                        f.normalizeLocalePath(R.effect.parsedAs.pathname, P.locales).pathname
                                    )),
                                    (c = P.components[e]),
                    ...
                    return n(function* () {
                        ...
                        (n.pathname = F(n.pathname, c)),
                            m.isDynamicRoute(n.pathname) &&
                                ...
                                Object.assign(
                                    s,
                                    y.getRouteMatcher(v.getRouteRegex(n.pathname))(P.parsePath(t).pathname) || {}
                                ),
                ...
                getInitialProps(e, t) {
                    let { Component: r } = this.components['/_app'],
                        n = this._wrapApp(r);
                    return (
                        (t.AppTree = n), h.loadGetInitialProps(r, { AppTree: n, Component: e, router: this, ctx: t })
                    );
                }
                get route() {
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }),
                ...
                (t.normalizeRepeatedSlashes = function (e) {
                    let t = e.split('?'),
                        r = t[0];
                    return (
                        r.replace(/\\/g, '/').replace(/\/\/+/g, '/') + (t[1] ? '?'.concat(t.slice(1).join('?')) : '')
                    );
                }),
