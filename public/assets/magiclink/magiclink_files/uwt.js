    ...
    var t = {
                    ...
                    function g(t, e) {
                        ...
                        if (void 0 === n) {
                            if (((e.delegate = null), 'throw' === e.method)) {
                                if (
                                    t.iterator.return &&
                                    ((e.method = 'return'), (e.arg = void 0), g(t, e), 'throw' === e.method)
                                )
                                    return l;
                                (e.method = 'throw'),
                    ...
                    return (function (t) {
                        for (var e = [], n = 32 * t.length, r = 0; r < n; r += 8) {
                            var i = (t[r >> 5] >>> r % 32) & 255,
                                o = parseInt(
                                    '0123456789abcdef'.charAt((i >>> 4) & 15) + '0123456789abcdef'.charAt(15 & i),
                                    16
                                );
                            e.push(o);
                        }
            ...
            6057: function (t, e, n) {
                ...
                e.track_DEPRECATED = function (t, e, n) {
                    ...
                    var i = new c.AccountParams({ merch_id: t }),
                        o = new c.EventParams(
                            r(
                                { merch_id: t, events: e, eci: l.utilities.EventCodeImpl.DEPRECATED_TRACK },
                                n ? { value: n.toString() } : {}
                            )
                        );
                    s.track({ accountParams: i, eventParams: o, adsApiVersion: l.utilities.AdsApiVersion.v0 });
                };
            ...
            510: function (t, e, n) {
                ...
                e.config = function (t, e) {
                    ...
                    u.track({ accountParams: n, eventParams: d, adsApiVersion: s.utilities.AdsApiVersion.v1 }),
                ...
                e.event = function (t, e) {
                    ...
                    u.track({ accountParams: n, eventParams: h, adsApiVersion: s.utilities.AdsApiVersion.v1 });
                };
            },
            3324: function (t, e, n) {
                'use strict';
                ...
                e.trackPid = function (t, e) {
                    ...
                    u.track({ accountParams: n, eventParams: i, adsApiVersion: s.utilities.AdsApiVersion.v0 });
                };
            },
            1454: function (t, e, n) {
                'use strict';
                ...
                e.track = function (t, e) {
                    ...
                    s.track({ accountParams: c, eventParams: a, adsApiVersion: l.utilities.AdsApiVersion.v0 });
                };
            },
            1952: function (t, e, n) {
                'use strict';
                        ...
                        var e,
                            n =
                                t.call(this, {
                                    ...
                                    p_user_id: '0',
                                    integration:
                                        (null === (e = window.twq) || void 0 === e ? void 0 : e.integration) ||
                                        'advertiser',
                                }) || this;
                                ...
                                switch (c.label) {
                                    ...
                                    case 3:
                                        return (
                                            ...
                                            (a = s.trackPid(o, { adsApiVersion: r, needResponse: t })),
                                            t &&
                    ...
                    i = (function () {
                        ...
                        return (
                            (t.setCookie = function (e, n, i) {
                                if ((void 0 === i && (i = {}), !e))
                                    throw new Error(r.LogPrefix + ' Missing key for ' + e + ' cookie');
                            ...
                            (t.convertCookieOptionsToString = function (t) {
                                if (!t)
                                    throw new Error(r.LogPrefix + ': convertCookieOptionsToString is missing options');
                                var e = '';
                                for (var n in t)
                                    r.hasOwnPropertyCi(t, n) &&
                                        ('secure' === n && t[n] ? (e += ';' + n) : (e += ';' + n + '=' + t[n]));
