  ...
  return (
    <>
      <div className={`container my-5 ${showInsms ? "insms" : ""}`}>
        ...
        <FaqSection faqData={productData?.otp} />
        ...
        {/* <div>
          ...
          <div className="accordion accordion-flush" id="accordionFlushExample">
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  An OTP SMS service provider, like MSG91, offers a platform and
                  infrastructure to send One-Time Passwords (OTPs) via SMS for
                  authentication, verification, and secure access to user accounts or
                  transactions.
                </div>
              </div>
            </div>
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  An OTP authentication API is a software interface provided by MSG91 that
                  allows businesses to integrate OTP-based authentication into their
                  applications or systems. It enables the generation, delivery, and
                  verification of OTPs seamlessly.
                </div>
              </div>
            </div>
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  An OTP SMS gateway, such as the one provided by MSG91, acts as a bridge
                  between the application generating the OTP and the mobile network
                  operators. It ensures the reliable and timely delivery of OTP messages
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  MSG91 is regarded as the best OTP SMS service provider in India due to
                  its robust platform, high message deliverability, comprehensive
                  features, excellent customer support, and a proven track record of
                  serving businesses of all sizes across various industries.
                </div>
              </div>
            </div>
            <div className="accordion-item">
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  Getting started with MSG91's OTP SMS services is easy. Simply reach out
                  to our team or visit our website to explore our offerings. We provide
                  seamless integration, extensive documentation, and dedicated support to
                  help you implement OTP authentication effectively.
                </div>
              </div>
            </div>
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  ...
                  small business or an enterprise-level operation, our infrastructure can
                  handle high message volumes, ensuring that your OTPs are delivered
