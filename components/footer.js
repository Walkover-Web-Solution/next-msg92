                ...
                <div className="footer_Main_Content mt-4 mb-4 container">
                    <div className="row justify-content-sm-between">
                        <div className="col-6 col-lg-4 mb-4">
                            <h3 className="c-fs-5 d-flex flex-column">Our products</h3>
                        ...
                        <div className="col-6 col-lg-3 mb-4">
                            <h3 className=" c-fs-5 d-flex flex-column">Channels</h3>
                            <div className="a-nav-link-cont d-flex flex-column mt-2 align-items-start">
                            ...
                            <h3 className="c-fs-5 d-flex flex-column mt-5">Resources</h3>
                            <div className="a-nav-link-cont d-flex flex-column mt-2 align-items-start">
                                <a href="/guide" target="_blank" className="c-link-underline c-fs-5 mt-2 c-fw-t">
                                    Guide
                                </a>
                        ...
                        <div className="col-6 col-lg-3 mb-4">
                            <h3 className=" c-fs-5 d-flex flex-column">Discover</h3>
                            <div className="a-nav-link-cont d-flex flex-column mt-2 align-items-start">
                                <a href="/about-us" className="c-link-underline c-fs-5 mt-2 c-fw-t">
                                    About us
                                </a>
                                <a href="/pricing/sms" className="c-link-underline c-fs-5 mt-2 c-fw-t">
                                    Pricing
                                </a>
                                ...
                                <a href="/startups" className="c-link-underline c-fs-5 mt-2 c-fw-t">
                                    MSG91 for startups
                                </a>
                                ...
                                <a href="/certificates" target="_blank" className="c-link-underline c-fs-5 mt-2 c-fw-t">
                                    Certificates
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="d-flex d-lg-block col-12 col-lg-2 f-social-a-cont mb-4 text-start text-lg-end order-first order-lg-last">
                            <div className="footer-social-a-content col-6 col-lg-12">
                                <span className="footer-social-a-text  c-fs-5 d-flex flex-column">Download Apps</span>
                            ...
                            <div className="footer-social-a-content col-6 col-lg-12 mt-lg-5">
                                <span className="footer-social-a-text c-fs-5 d-flex flex-column">Follow us</span>
                                <div className="footer-social-a d-flex mt-3 align-items-start justify-content-between justify-content-lg-end">
                                    <a href="https://www.facebook.com/msg91" target="_blank" className="me-3">
                                        <img src="/img/icon/facebook.svg" width={24} height={24} alt="#" />
                                    </a>
                                    <a href="https://www.linkedin.com/company/msg91/" target="_blank" className="me-3">
                                        <img src="/img/icon/linkedin.svg" width={24} height={24} alt="#" />
                                    </a>
                                    <a href="https://twitter.com/msg91" target="_blank" className="me-3">
