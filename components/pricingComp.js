    ...
    <>
      <div className="container d-flex justify-content-center">
        <div className="text-center py-5">
          ...
          <div className="d-flex d-sm-none align-items-center w-100">
            <select
              className="form-select mx-auto mb-3 w-25"
            ...
            >
              ...
              <button
                    className="nav-link"
                    data-bs-toggle="pill"
                    data-bs-target="#pills-knowledgebase"
                    type="button"
                    role="tab"
                    aria-controls="pills-campaign"
                    aria-selected="false"
          ...
          <div className="c-fs-3 ">
            ...
            <div className="tab-content d-flex " id="pills-tabContent">
              ...
              <div
                ...
                id="pills-hello"
                role="tabpanel"
                aria-labelledby="pills-hello-tab"
                tabIndex={0}
              >
                <Pricinghello countryCode={countryCode} />
              </div>
              ...
              <div
                ...
                id="pills-segmento"
                role="tabpanel"
                aria-labelledby="pills-segmento-tab"
                tabIndex={0}
              >
                <Pricingsegmento
              ...
              <div
                className="tab-pane fade w-100"
                id="pills-knowledgebase"
                role="tabpanel"
                aria-labelledby="pills-knowledgebase-tab"
                tabIndex={0}
              >
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              {countryCode == "IN" ? (
                ...
                <InlineWidget
                  url="https://calendly.com/msg91international/talktoexpert"
                  styles={{ height: "700px" }}
                />
              )}
            </div>
