        ...
        <div className="col-12  terms-content c-fs-4">
          ...
          <div className="mb-5">            
            ...
            <ul>              
              ...
              <li>“User” means an employee, agent, or representative of a Client who primarily uses the restricted areas of the Site for the purpose of accessing the Service in such a capacity.</li>
          ...
          <strong>What personal information do we collect from the people who visit our blog, website, or app?</strong>
          ...
          <p>Improvements</p>
          <p>We use the information to understand and analyze the usage trends and preferences of our Visitors and Users, to improve the Service, and to develop new products, services, features, and functionality.</p>
          ...
          <p>Unrestricted Information: Any information that you voluntarily choose to include in a Public Area of the Service, such as a public profile page, will be available to any Visitor or User who has access to that content.</p>
          <p>Service Providers (Sub Processors): We work with third-party service providers who provide website, application development, hosting, maintenance, and other services for us. These third parties may have access to, or process Personal Data or Client Data as part of providing those services for us. We limit the information provided to these service providers to that which is reasonably necessary for them to perform their functions, and our contracts with them require them to maintain the confidentiality of such information.</p>
          
          <strong>List of Processors</strong>
          <ol>
            <li>Amazon Web Services <br></br>
Hosting services in the US</li>
            <li>Stripe<br></br>
Payment gateway (PCI compliant)</li>
            <li>Paypal<br></br>
Payment gateway (PCI compliant)</li>
            <li>Razorpay<br></br>
Payment gateway (PCI compliant)</li>
...
Business Analytics</li>
            <li>Rollbar<br></br>
Error Tracking</li>
            <li>Google (Gmail)<br></br>
To allow customers to send emails via Gmail</li>
            <li>Microsoft365 (Outlook)<br></br>
To allow customers to send emails via Outlook</li>
            <li>Google (Google Analytics)<br></br>
Business Analytics</li>
            <li>Google ads<br></br>
Marketing</li>
            <li>Facebook Ads<br></br>
Marketing</li>            
          </ol>
          ...
          <p>in the good-faith belief that such action is necessary to comply with applicable laws, respond to a valid court order, judicial or other government subpoena, or warrant, or cooperate with law enforcement or other governmental agencies.</p>
          ...
          <p>If you receive commercial emails from us, you can unsubscribe at any time by following the instructions within the email or by sending an email to hello@msg91.com.</p>
          ...
          <ol>
            ...
            <li>information on legal transactions between Client and MSG91 is retained for a period of 5 years.</li>
          </ol>
          ...
          <p>We may update this Privacy Policy periodically without prior notice. However, it's important to note that we will not introduce changes leading to significant additional uses or disclosures of your personal information without notifying you via email. In addition, we may implement non-significant changes to this Privacy Policy that generally won't have a significant impact on how we use your personal information, and such changes won't require an email notification.</p>
          <p>We recommend checking this page regularly for any updates. If you find any non-significant changes to this Privacy Policy unacceptable, please reach out to us immediately. Until the matter is resolved, please refrain from using the MSG91 website and any services we provide. Your continued use of our services and the MSG91 website after non-significant changes to this Privacy Policy are posted indicates your acceptance of those changes.</p>
