const gdpr = () => {
    return (
        <>
            <div className="mb-5">
                <h1 className="c-fs-2 c-fw-m">GDPR</h1>
            ...
            <div className="mb-5">
                <h1 className="c-fs-2 c-fw-m">You can always Opt-out</h1>
                <span className="c-fs-4">
            ...
            <div className="mb-5">
                <h1 className="c-fs-2 c-fw-m">We offer you Erasability</h1>
                <span className="c-fs-4">
            ...
            <div className="mb-5">
                <h1 className="c-fs-2 c-fw-m">We believe in fair practices</h1>
                <span className="c-fs-4">
            ...
            <div className="mb-5">
                <h1 className="c-fs-2 c-fw-m">We have a Singapore-based data center</h1>
                <span className="c-fs-4">
            ...
            <div className="mb-5">
                <h1 className="c-fs-2 c-fw-m">Full Support Assistance whenever required</h1>
                <span className="c-fs-4">
            ...
            <div className="mb-5">
                <h1 className="c-fs-2 c-fw-m">We protect your Data Subjects</h1>
                <span className="c-fs-4">
            ...
            <div className="mb-5">
                <h1 className="c-fs-2 c-fw-m">We believe in Clear Communication</h1>
                <span className="c-fs-4">
