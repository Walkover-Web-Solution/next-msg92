    ...
    return(
        ...
        <div className="d-flex flex-column gap-3 my-5">
            ...
            <div className="d-flex gap-3 justify-content-center">
                <Image className="trustimage" src="/img/trusted/ixigo.svg" width="187" height="28" alt="trustimage"/>
                ...
                <Image className="trustimage" src="/img/trusted/housing.svg" width="187" height="28" alt="trustimage"/>
            </div>
        </div>
