        ...
        <>
            <div className={`d-flex flex-column gap-3 my-md-5 my-2`}>
                {pathArray && pathArray[1] === "br-pt" ? (
                    ...
                    <span className="c-fs-3 ">
                        Trusted by<span className="c-fw-sb"> 30,000+ </span>global businesses
                    </span>
                )}
                <div
                    className={`d-flex gap-4 gap-md-5 flex-wrap align-items-center ${
                        align == "center" ? "justify-content-center" : "justify-content-start"
                    }`}
                >
                    <Image
                        className="trustimage "
                        src="/img/trusted/razorpay.svg"
                        width="187"
                        height="28"
                        alt="Razorpay"
                        title="Razorpay"
                    ...
                    />
                    <Image
                        className="trustimage d-none d-lg-block"
                    ...
                    <Image
                        className="trustimage"
                        src="/img/trusted/indian-oil.svg"
                        width="32"
                        height="32"
                        alt="Indian Oil"
                        title="Indian Oil"
                    ...
                    <Image
                        className="trustimage d-lg-block"
