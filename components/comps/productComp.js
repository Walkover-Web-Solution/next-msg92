            ...
            <div className="product-banner-wrp">
                <div className="container text-center overflow-hidden">
                    <div className=" mx-auto text-center justify-content-center py-2 py-md-5 col-12 col-sm-8">
                        ...
                        <div className="p-3">
                            <h2 className="heading w-md-75 w-100 mx-auto mb-2 c-fw-xb">{pageData?.heading}</h2>
                    ...
                    <TrustedBy />
                    <img src={pageData?.pageimg} className="img-fluid product-page-img mx-auto" alt="product image" />
                </div>
            </div>
                ...
                <div className="container mb-5">
                    ...
                    <div className="col-6 ">
                        <div className="d-flex gap-3 p-4 req-feature-cont justify-content-between align-items-center">
                            ...
                            <a href="https://features.msg91.com/feature-requests">
                                <button className="w-90 p-2 btn">
                                    Request a Feature <AiOutlineArrowRight />
                                </button>
                            </a>
                        </div>
                    </div>
