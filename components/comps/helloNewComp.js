        ...
        <>
            ...
            <div className="discover py-5 py-md-5">
                <div className="container py-4">
                    ...
                    <div className="c-fs-2 mt-3">
                        Our cutting-edge application is designed to empower businesses across every industry with a
                        suite of features that are not only transformative but also tailored to your needs.
                    </div>
                    ...
                    <div className="c-fs-2 mt-3">
                        No matter if you're in ecommerce, fintech, healthcare, or any other field, HELLO is the ultimate
                        solution to elevate your communication game.
                    </div>
                </div>
            </div>

            <div
                className={`px-sm-0 d-flex flex-column justify-content-center justify-content-sm-start section hello-new-features py-5`}
            >
                {pageData?.features?.map((item, index) => {
                    if (item?.content) {
                        ...
                        return (
                            <div
                                key={`f-${index}`}
                                className={`container hnf flex-column d-flex my-3 my-md-5 align-items-center justify-content-md-between justify-content-center ${
                                    i % 2 ? 'flex-md-row-reverse' : 'flex-md-row'
                                } ${i % 3 === 1 ? 'yellow' : ''}${i % 3 === 2 ? 'purple' : ''}${
                                    i % 3 === 0 ? 'blue' : ''
                                }`}
                            >
            ...
            <div className="marquee-wrp py-3 py-md-5">
                ...
                <div className="container">
                    <div className="c-fs-2 mt-3">
                        At MSG91, we're not just offering a communication solution; We're offering a game-changer for
                        businesses of all sizes and industries.
                    </div>
                    <div className="c-fs-2 mt-3">
                        With HELLO, you're not just communicating – you're connecting, engaging, and thriving. Embrace
                ...
                <div className="container">
                    <div className="c-fs-2 mt-3">
                        Ready to transform the way you communicate? Say HELLO to your business's next big leap. Get
                    ...
                    <a
                        href="/contact-us"
                        className="btn btn-outline-dark btn-lg c-fs-2 mt-4  mb-4 utm get-started-hello"
                    >
                        CONTACT SALES
                    </a>
                  ...
                  >
                    ...
                    <div className="px-3 mt-5 mb-4">
                        <div className="price-card p-4 d-flex flex-wrap align-items-center">
                            <div className="c-fs-2 col-12 col-md-8 col-lg-8">
                                For a personalised plan to meet your custom need.
                            </div>
                            <a
                                href="/contact-us"
                                className="btn btn-outline-dark btn-lg c-fs-2 utm get-started-hello col-12 col-md-4 col-lg-4"
                            >
                                CONTACT SALES
                            </a>
                        </div>
