              ...
              <a href="/hello" className="product-card hello-card flex-row text-dark mb-4">          
                <div className="row">
                  ...
                  <div className="product-img d-flex justify-content-end col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 align-items-start">
                    <img src="./img/home/chats.svg" alt="hello image"/>
                  </div>          
                </div>
              </a>
            </div>
        ...
        <div className="d-flex my-5 flex-lg-row flex-column gap-4">
          ...
          >
            ...
            <div className="d-flex flex-column gap-3 justify-content-between  h-100">
              <div className="">
                <span className="mb-3 c-fs-3 fw-medium">Make your long URLs short</span>
                <p className="c-fs-4">
          ...
          >
            ...
            <div className="d-flex flex-column gap-3 justify-content-between h-100">
              <div className="">
                <span className="mb-3 c-fs-3 fw-medium">
          ...
          >
            ...
            <div className="d-flex flex-column gap-3 justify-content-between h-100">
              <div className="">
                <span className="mb-3 c-fs-3 fw-medium">Simple and secured file storage</span>
                <p className="c-fs-4">
