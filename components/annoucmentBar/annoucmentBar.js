        ...
        <div className='container d-flex align-items-center gap-2 py-2 '> 
            ...
            <div className="d-flex flex-column ">
                ...
                <span className="text-white-800 c-fs-5">
                    Mastering E-commerce with WhatsApp Campaigns that Convert and get benefits worth INR 25,000 <a className='text-white c-fw-b text-decoration-underline' href="https://forms.gle/2Er1hw4GYkupmebb8"> Register Now </a>
                </span>
            </div>
        </div>
        </div>
