                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                        {data?.cards?.map((card, index) => {
                            ...
                            return (
                                <article
                                    key={index}
                                    className={`min-h-[265px] border border-gray-200 rounded-xl p-6 relative overflow-hidden flex flex-col justify-between ${
                                        isLarge
                                ...
                                >
                                    ...
                                    {index === 0 && (
                                        <div
                                            aria-hidden='true'
                                            className='absolute -right-2.5 -bottom-7 w-[180px] h-[115px] border border-sky-100 bg-white rounded-tl-xl p-2.5 pointer-events-none'
                                        >
